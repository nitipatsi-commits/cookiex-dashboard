                    ...
                    if target_obj:
                        ...
                        try:
                            if cur_exp_raw and not pd.isna(cur_exp_raw):
                                ...
                                cur_exp_str = (now_thai + timedelta(days=30)).strftime("%Y-%m-%d %H:%M:%S")
                        except Exception:
                            cur_exp_str = (now_thai + timedelta(days=30)).strftime("%Y-%m-%d %H:%M:%S")
